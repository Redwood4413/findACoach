...
export default {
  ...
  methods: {
    ...
    inputsValidation() {
      const {
        name, email, message, nameValidation, emailValidation, messageValidation,
      } = this;
      nameValidation();
      emailValidation();
      messageValidation();
...
<template>
  ...
  >
    ...
    <div class="input-wrapper">
      ...
      <div class="validation">
        <span class="invalid" v-if="!email.isValid">Your e-mail is invalid!</span>
    ...
    <div class="input-wrapper">
      ...
      <div class="validation">
        <span class="invalid" v-if="!message.isValid">Your message is too long!</span>
        <span class="counter">{{ message.data.length }}/{{ message.maxLen }}</span>
      </div>
    </div>
    <div class="buttons">
